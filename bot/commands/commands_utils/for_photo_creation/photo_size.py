...
TXT_FILE = "photo_size.txt"
TXT_SIZE_PATH = os.path.join("bot", "commands", "commands_utils", "for_photo_creation", TXT_FILE)
...
def write_to_txt(width, height):
    ...
    with open(TXT_SIZE_PATH, "w+") as size_txt:
        size_txt.write(
...
def get_data_from_txt() -> str:
    with open(TXT_SIZE_PATH, "r") as size_txt:
        result = size_txt.read()

    return result


# write_to_txt(100, 100)