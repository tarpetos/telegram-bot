...
from bot.keyboards.password_generator.radio_keyboard import first_generator_keyboard, all_button, letters_button, \
    digits_button, let_dig_button, let_sig_button, dig_sig_button
