...
from bot.bot_main.for_password_generation.password_content_callbacks import (
...
from bot.keyboards.password_generator.generation_keyboard import (
...
from bot.keyboards.password_generator.return_to_update_keyboard import (
    password_generator_return_to_update,
)
from bot.keyboards.password_generator.telegram_keyboard import (
    password_telegram_keyboard,
)
from bot.keyboards.password_generator.update_keyboard import (
    password_generator_update_keyboard,
)
from bot.other_functions import check_for_comma_and_dot, check_for_id_in_table
from bot.other_functions.check_for_repetetive_characters import (
...
async def process_password_update(message: types.Message, state: FSMContext):
    try:
        ...
        repetetive_characters_in_password = check_if_repeatable_characters_is_present(
            user_data
        )
        user_chosen_id = check_for_comma_and_dot.check_user_id(message.text)
