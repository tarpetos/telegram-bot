...
telegram_app_button = InlineKeyboardButton(
    text="Move to telegram generator", callback_data="telegram_password"
)
app_button = InlineKeyboardButton(
    text="Download desktop application", callback_data="password_app"
)
