...
generate_button = InlineKeyboardButton(text='Generate password', callback_data='generate_password')
write_to_db_button = InlineKeyboardButton(text='Store in database', callback_data='srote_in_db')
back_button = InlineKeyboardButton(text='Back', callback_data='back_to_second')
return_to_start = InlineKeyboardButton(text='Main generator menu', callback_data='main_generator_menu')
