...
close_scheduler = InlineKeyboardButton(
    text="Close keyboard", callback_data="close_scheduler"
)

scheduler_keyboard.add(task_button1).add(task_button2).insert(task_button3).add(
    task_button4
).add(close_scheduler)
